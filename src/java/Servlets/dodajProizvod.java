...
public class dodajProizvod extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String query = "INSERT INTO proizvodi (naziv, cijena, opis) VALUES ('" + naziv + "', '" + cijena + "', '" + opis + "')";
            Connection con = null;
            Statement stmt = null;
            String nextAddress = "dodajProizvod.jsp";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(dodajProizvod.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
